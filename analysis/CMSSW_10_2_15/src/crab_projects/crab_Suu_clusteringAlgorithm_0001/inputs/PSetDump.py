...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:B2G-RunIIAutumn18MiniAOD-00001_98.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ClusteringAlgorithm_output.root')
)
...
process.p = cms.Path(process.clusteringAnalyzer)
