...
fileNames = cms.untracked.vstring("file:B2G-RunIIAutumn18MiniAOD-00001_99.root")
   #fileNames = cms.untracked.vstring("file:Suu4TeV_chi850GeV.root")
   #fileNames = cms.untracked.vstring("/store/mc/RunIIAutumn18MiniAOD/
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("diquark_850GeV_Suu4TeV_output.root")
)
